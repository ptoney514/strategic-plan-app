...
export function WelcomeBanner() {
  ...
  return (
    <section className="rounded-2xl relative overflow-hidden shadow-lg shadow-indigo-500/10">
      {/* Background with gradient */}
      <div className="absolute inset-0 bg-gradient-to-r from-indigo-600 via-indigo-600 to-purple-600" />
      <div
      ...
      <div className="absolute bottom-0 left-0 -mb-20 -ml-20 w-60 h-60 bg-purple-400/20 rounded-full blur-3xl" />
      ...
      <div className="relative flex items-center p-8">
        <div className="flex items-center gap-6 w-full max-w-4xl">
          ...
          <div className="relative shrink-0">
            ...
            {/* Online indicator */}
            <div className="absolute bottom-1 right-1 w-5 h-5 bg-emerald-400 border-[3px] border-indigo-600 rounded-full" />
          </div>
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap items-center gap-4 text-indigo-100 text-sm font-medium">
